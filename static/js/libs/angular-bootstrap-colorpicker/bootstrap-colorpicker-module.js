angular.module('colorpicker.module', [])
    ...
    .directive('colorpicker', ['$rootScope','$document', '$compile', 'Color', 'Slider', 'Helper','AUTH_EVENTS', function ($rootScope,$document, $compile, Color, Slider, Helper,AUTH_EVENTS) {
      'use strict';
      return {
        require: '?ngModel',
        restrict: 'A',
        link: function ($scope, elem, attrs, ngModel) {
          ...
          sliderSaturation
              .on('click', function(event) {
                ...
                angular.element('#dropdown-color-picker').hide();

                angular.element('.close-colorpicker').trigger('click');
              })
              .on('mousedown', function(event) {
                Slider.setSaturation(event, fixedPosition, componentSize);
                bindMouseEvents();
