...
class Os extends AbstractDAO
{
    ...
    public static function get($params)
    {
        try {
            ...
            $params['os_id'] = is_null($params['os_id']) ? array() : (array)$params['os_id'];
            ...
            //Create Statement
            $stmt = $adapter->createStatement('BEGIN PKG_OS.GET(
                :p_USER_ID,
                :p_NETWORK_ID,
                :p_OS_ID,
                :p_COLUMNS,
            ...
            $parameterContainer->offsetSet('p_OS_ID', $params['os_id'], $parameterContainer::TYPE_ARRAY_NUM);
