...
class Utils
{
    ...
    public static function runJob($instance = 'info_buyer', $class = '', $function = '', $priority = 'doTask', $workload = '', $param = array())
    {
        //add param job
        $param['job'] = array(
            'class' => $class,
...
//        $image_src = $uploadDir . '/' . $basename;
    ...
    public static function buildCollectionObject($object)
    {
        $data_unserialize = unserialize($object);

        $total = $data_unserialize['_totalRecords'];
        //
        $collection_name = '';
        $data = null;
        if (isset($data_unserialize['storage']) && !empty($data_unserialize['storage'])) {
            $first_object_name = current($data_unserialize['storage']);
            $collection_name = get_class($first_object_name);
            $collection_name = str_replace('Model', "Collection", $collection_name);
        }
        //
        if ($collection_name) {
            $data = new $collection_name($data_unserialize['storage']);
            $data->setTotalRecords($total);
        }

        return $data;
    }

    public static function mappingStatusCreativeToCampaignAndLineitem($creative_status)
    {
        $data = array(
            'operational_status_creative' => null,
            'operational_status_campaign' => null,
            'operational_status_lineitem' => null
        );

        switch ($creative_status) {
            case Model\Creative::CREATIVE_STATUS_WAIT_RECHARGE:
                $data = array(
                    'operational_status_creative' => Model\Creative::CREATIVE_STATUS_V3_UNDER_REVIEW,
                    'operational_status_campaign' => Model\Campaign::CAMPAIGN_STATUS_V3_ELIGIBLE,
                    'operational_status_lineitem' => Model\LineItem::LINEITEM_STATUS_V3_ELIGIBLE
                );

                break;
            case Model\Creative::CREATIVE_STATUS_WAIT_APPROVE_AFTER_WAIT_RUN:
                $data = array(
                    'operational_status_creative' => Model\Creative::CREATIVE_STATUS_V3_UNDER_REVIEW,
                    'operational_status_campaign' => Model\Campaign::CAMPAIGN_STATUS_V3_ELIGIBLE,
                    'operational_status_lineitem' => Model\LineItem::LINEITEM_STATUS_V3_ELIGIBLE
                ...
                break;
            case Model\Creative::CREATIVE_STATUS_WAIT_APPROVE_AFTER_PAUSED:
                $data = array(
                    'operational_status_creative' => Model\Creative::CREATIVE_STATUS_V3_PAUSE_UNDER_REVIEW,
                    'operational_status_campaign' => Model\Campaign::CAMPAIGN_STATUS_V3_ELIGIBLE,
                    'operational_status_lineitem' => Model\LineItem::LINEITEM_STATUS_V3_ELIGIBLE
                );

                break;
            case Model\Creative::CREATIVE_STATUS_WAIT_APPROVE_AFTER_PAUSED_AGAIN:
                $data = array(
                    'operational_status_creative' => Model\Creative::CREATIVE_STATUS_V3_PAUSE_UNDER_REVIEW,
                    'operational_status_campaign' => Model\Campaign::CAMPAIGN_STATUS_V3_ELIGIBLE,
                    'operational_status_lineitem' => Model\LineItem::LINEITEM_STATUS_V3_ELIGIBLE
                ...
                break;
            case Model\Creative::CREATIVE_STATUS_NOT_APPROVE_AFTER_WAIT_RUN:
                $data = array(
                    'operational_status_creative' => Model\Creative::CREATIVE_STATUS_V3_DISAPPROVE,
                    'operational_status_campaign' => Model\Campaign::CAMPAIGN_STATUS_V3_ELIGIBLE,
                    'operational_status_lineitem' => Model\LineItem::LINEITEM_STATUS_V3_ELIGIBLE
                );

                break;
            case Model\Creative::CREATIVE_STATUS_NOT_APPROVE_AFTER_PAUSED:
                $data = array(
                    'operational_status_creative' => Model\Creative::CREATIVE_STATUS_V3_PAUSE_DISAPPROVE,
                    'operational_status_campaign' => Model\Campaign::CAMPAIGN_STATUS_V3_ELIGIBLE,
                    'operational_status_lineitem' => Model\LineItem::LINEITEM_STATUS_V3_ELIGIBLE
                );

                break;
            case Model\Creative::CREATIVE_STATUS_WAIT_RUN:
                $data = array(
                    'operational_status_creative' => Model\Creative::CREATIVE_STATUS_V3_APPROVE,
                    'operational_status_campaign' => Model\Campaign::CAMPAIGN_STATUS_V3_ELIGIBLE,
                    'operational_status_lineitem' => Model\LineItem::LINEITEM_STATUS_V3_PENDING
                );

                break;
            case Model\Creative::CREATIVE_STATUS_RUNNING:
                $data = array(
                    'operational_status_creative' => Model\Creative::CREATIVE_STATUS_V3_APPROVE,
                    'operational_status_campaign' => Model\Campaign::CAMPAIGN_STATUS_V3_ELIGIBLE,
                    'operational_status_lineitem' => Model\LineItem::LINEITEM_STATUS_V3_ELIGIBLE
                ...
                break;
            case Model\Creative::CREATIVE_STATUS_PAUSE_BEFORE_APPROVE:
                $data = array(
                    'operational_status_creative' => Model\Creative::CREATIVE_STATUS_V3_PAUSE_UNDER_REVIEW,
                    'operational_status_campaign' => Model\Campaign::CAMPAIGN_STATUS_V3_ELIGIBLE,
                    'operational_status_lineitem' => Model\LineItem::LINEITEM_STATUS_V3_ELIGIBLE
                ...
                break;
            case Model\Creative::CREATIVE_STATUS_PAUSE_AFTER_APPROVE:
                $data = array(
                    'operational_status_creative' => Model\Creative::CREATIVE_STATUS_V3_PAUSE_APPROVE,
                    'operational_status_campaign' => Model\Campaign::CAMPAIGN_STATUS_V3_ELIGIBLE,
                    'operational_status_lineitem' => Model\LineItem::LINEITEM_STATUS_V3_ELIGIBLE
                );

                break;
            case Model\Creative::CREATIVE_STATUS_OUT_OF_BUDGET_PERIOD:
                $data = array(
                    'operational_status_creative' => Model\Creative::CREATIVE_STATUS_V3_APPROVE,
                    'operational_status_campaign' => Model\Campaign::CAMPAIGN_STATUS_V3_ELIGIBLE,
                    'operational_status_lineitem' => Model\LineItem::LINEITEM_STATUS_V3_ELIGIBLE_DAILY
                );

                break;
            case Model\Creative::CREATIVE_STATUS_COMPLETE_BY_TIME:
                $data = array(
                    'operational_status_creative' => Model\Creative::CREATIVE_STATUS_V3_APPROVE,
                    'operational_status_campaign' => Model\Campaign::CAMPAIGN_STATUS_V3_ELIGIBLE,
                    'operational_status_lineitem' => Model\LineItem::LINEITEM_STATUS_V3_END
                );

                break;
            case Model\Creative::CREATIVE_STATUS_OUT_OF_BUDGET:
                $data = array(
                    'operational_status_creative' => Model\Creative::CREATIVE_STATUS_V3_APPROVE,
                    'operational_status_campaign' => Model\Campaign::CAMPAIGN_STATUS_V3_ELIGIBLE,
                    'operational_status_lineitem' => Model\LineItem::LINEITEM_STATUS_V3_ELIGIBLE_LIFETIME
                );

                break;
            case Model\Creative::CREATIVE_STATUS_OUT_OF_USER_BALANCE:
                $data = array(
                    'operational_status_creative' => Model\Creative::CREATIVE_STATUS_V3_APPROVE,
                    'operational_status_campaign' => Model\Campaign::CAMPAIGN_STATUS_V3_ELIGIBLE,
                    'operational_status_lineitem' => Model\LineItem::LINEITEM_STATUS_V3_ELIGIBLE
                ...
                break;
            case Model\Creative::CREATIVE_STATUS_STOP:
                $data = array(
                    'operational_status_creative' => Model\Creative::CREATIVE_STATUS_V3_REMOVED,
                    'operational_status_campaign' => Model\Campaign::CAMPAIGN_STATUS_V3_REMOVED,
                    'operational_status_lineitem' => Model\LineItem::LINEITEM_STATUS_V3_REMOVED
                );

                break;
            case Model\Creative::CREATIVE_STATUS_DELETE:
                $data = array(
                    'operational_status_creative' => Model\Creative::CREATIVE_STATUS_V3_DELETED,
                    'operational_status_campaign' => Model\Campaign::CAMPAIGN_STATUS_V3_DELETED,
                    'operational_status_lineitem' => Model\LineItem::LINEITEM_STATUS_V3_DELETED
                );
